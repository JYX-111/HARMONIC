...
# =========================================================
# Anti-aliased grid supersampling (reduce pixelation)
# =========================================================
GRID_SUPERSAMPLE = 3

# =========================================================
# background grid size control (0~1)
# smaller -> larger bricks
# =========================================================
MAX_GRID_SCALE = 3.0

# =========================================================
# Hi-res export (pixel-driven)
# =========================================================
EXPORT_DPI = 300
...
def _scaled_geom_params(p: float):
    """
    Scale brick sizes by p.
    Smaller p -> bigger bricks.
    """
...
def make_brick_texture(Hh: int, Ww: int, brick_w: int, brick_h: int, mortar: int, angle: float) -> np.ndarray:
    ...
    Return float mask in [0,1], where 1 means LINE pixels (mortar), 0 means body.
    """
...
def _apply_grid_colors(bg: np.ndarray, mN: np.ndarray, grid_mask: np.ndarray) -> None:
    """
    grid_mask: float (H,W) where 1 means LINE pixels (mortar), 0 means body.
              (can be soft mask in [0,1] after AA)
    Apply:
      - body -> pink
      - mortar -> white
    """
